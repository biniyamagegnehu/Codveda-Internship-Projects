        ...
        <div className="gradient-border">
          <div className="glass-card p-8">
            ...
            >
              ...
              <p className="text-gray-400 mt-2">Join TaskFlow to manage your tasks</p>
            </motion.div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              >
                ...
                <div className="relative group">
                  <UserIcon className="absolute left-3 top-1/2 transform -translate-y-1/2 w-5 h-5 text-gray-400 group-focus-within:text-purple-400 transition-colors" />
                  <input
                    type="text"
                    value={name}
